    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                // Bug fix: new users get USER role, not ADMIN
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            // Bug fix: find by email properly
        ...
        private async Task EnsureRolesExistAsync()
        {
            if (!await _roleManager.RoleExistsAsync(AppRoles.ADMIN))
                await _roleManager.CreateAsync(new AppRole { Name = AppRoles.ADMIN });

            if (!await _roleManager.RoleExistsAsync(AppRoles.USER))
                await _roleManager.CreateAsync(new AppRole { Name = AppRoles.USER });
        }
    }
}
